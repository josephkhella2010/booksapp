...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    books: Attribute.Relation<
      ...
      'api::book.book'
    >;
    book_privates: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::book-private.book-private'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    img: Attribute.Media;
    rates: Attribute.Relation<'api::book.book', 'manyToMany', 'api::rate.rate'>;
    users: Attribute.Relation<
      'api::book.book',
      'manyToMany',
      'plugin::users-permissions.user'
...
export interface ApiBookPrivateBookPrivate extends Schema.CollectionType {
...
export interface ApiViewView extends Schema.SingleType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::book-private.book-private': ApiBookPrivateBookPrivate;
